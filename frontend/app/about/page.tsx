      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {values.map((val, i) => (
            <motion.div
              ...
              className="glass-card text-center hover:border-primary/40 transition-all p-6"
            >
        ...
        <div className="mt-20 glass-card p-8 md:p-12 relative overflow-hidden">
           <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-surface-alt rounded-2xl p-8 border border-theme">
                <p className="italic text-muted text-lg mb-6">"The WebGenixx transformed our legacy platform into a modern powerhouse. Their attention to detail is unmatched."</p>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-surface-card rounded-full"></div>
                  <div>
                    <p className="font-bold">TEAM THE WEBGENIXX</p>
                    <p className="text-sm text-muted">CEO at TechFlow</p>
                  </div>
                </div>
              </div>
           </div>
